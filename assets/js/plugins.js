/*
File: MALIK HUZAIFA/assets/js/plugins.js
Type: JavaScript file
Root details: Contains functions and top-level variables. Detected function names: k, L, x, D, S, n, i, N, I, z, q, dt, ut, ft, pt, mt, _t, vt, yt, wt, Et, At, Tt, Ot, Ct, kt, Lt, Nt, It, Pt, Mt, Bt, Ft, Vt, Kt, Xt, Yt, t, Qt, Gt, Zt, Jt, te, ie, ne, le, he, de, t, d, Fe, e, t, o, n, r, p, s, d, a, l, f, m, h, c, g, u, b, w, y, E, v, O, L, x, S, T, D, C, N, k, W, P, B, H, A, I, M, R, U, Y, j, F, K, q, V, z, G, e, t, b, c, c, e, b, a, b, c, b, c, d, e, f, d, f, i, b, c, d, e, b, c, d, e, a, f, g, h, g, c, d, a, c, b, c, a, d, c, h, b, a, a, b, n, i, t, l, u, t, c, f, t, e, d, f, p, h, m, o, g, c, n, e, t, t, v, b, N, x, s, a, l, d, a, a, v, l, D, O, A, G, B, H, X, l, t, t, s, C, d, h, n, r, e, a, o, c, d, e, f, g, h, i, j, k, a, a, a, a, _inheritsLoose, _assertThisInitialized, r, s, t, u, v, w, x, y, P, Q, R, S, T, ea, fa, ga, ha, ia, ja, ka, la, ma, na, oa, pa, qa, ta, ua, va, _setKeyframeDefaults, xa, ya, za, Aa, Ca, Ea, Ga, Ha, Ia, Ja, Ka, La, Ma, Ra, Sa, Va, Wa, Ya, _a, cb, db, eb, fb, gb, hb, lb, ob, rb, tb, yb, zb, Ab, Bb, Eb, Nb, _parseObjectInString, _valueInParentheses, Pb, Rb, easeOut, easeInOut, Sb, Tb, Hm, Ub, Pm, _merge, _animationCycle, _isFromOrFromStart, _parsePosition, _clamp, toArray, _flatten, mapRange, _callback, tick, deltaRatio, wake, sleep, lagSmoothing, fps, add, remove, _wake, _invertEase, _parseEase, wl, en, config, GSCache, delay, duration, totalDuration, totalTime, time, totalProgress, progress, iteration, timeScale, _recacheAncestors, paused, startTime, endTime, rawTime, revert, globalTime, repeat, repeatDelay, yoyo, seek, restart, play, reverse, pause, resume, reversed, invalidate, isActive, eventCallback, then, zo, kill, Animation, Timeline, to, from, fromTo, set, call, staggerTo, staggerFrom, staggerFromTo, render, _findNextPauseTween, add, getChildren, getById, remove, totalTime, addLabel, removeLabel, addPause, removePause, killTweensOf, getTweensOf, tweenTo, onStart, tweenFromTo, recent, nextLabel, previousLabel, currentLabel, shiftChildren, invalidate, clear, totalDuration, updateRoot, _b, _processVars, fc, _addPropTween, _addComplexStringPropTween, _initTween, _parseFuncOrString, Tween, _hasNoPausedAncestors, render, _renderZeroDurationTween, _parentPlayheadIsBeforeStart, targets, invalidate, resetTo, _updatePropTweens, kill, _arraysMatch, _addAliasesToVars, to, from, delayedCall, fromTo, set, killTweensOf, nc, vc, _setterPlain, _setterFunc, _setterFuncWithParam, _getSetter, _renderPlain, _renderBoolean, _renderComplexString, _renderPropTweens, _addPluginModifier, _killPropTweensOf, _sortPropTweensByPriority, modifier, PropTween, Cc, Dc, add, Cw, ignore, getTweens, clear, kill, revert, Context, add, revert, kill, MatchMedia, registerPlugin, _createPlugin, timeline, getTweensOf, getProperty, quickSetter, quickTo, Ux, isTweening, defaults, config, registerEffect, registerEase, parseEase, getById, exportRoot, context, matchMedia, matchMediaRefresh, addEventListener, removeEventListener, wrap, wrapYoyo, normalize, clamp, pipe, unitize, interpolate, func, func, reverting, context, suppressOverwrites, Hc, Jc, init, _addModifiers, init, render, init, td, ud, vd, wd, xd, yd, zd, Ad, Bd, Cd, Dd, Ed, Hd, Id, Jd, Kd, Md, Nd, Qd, _windowExists, Rd, Sd, Td, Ud, Vd, Wd, Zd, _d, be, ce, ge, he, ie, je, me, te, ue, ve, _checkPropPrefix, _get, clearProps, _parseTransform, _firstTwoOnly, _renderNon3DTransforms, _renderCSSTransforms, _renderSVGTransforms, targetTest, init, render, getSetter, t, t, t, t, e, t, t, t, e, i, t, t, t, s, n, d, l, r, o, c, h
Detected arrow/constant identifiers: e, s, n, o, t, B, f
...
! function(t, e) {
    ...
    "use strict";
/* === SECTION START: variable t === */
    const t = t => {
/* === SECTION START: variable e === */
            let e = t.getAttribute("data-bs-target");
            if (!e || "#" === e) {
/* === SECTION START: variable i === */
...
/* === SECTION START: function k === */

    function k(t, e) {
        return e && `${e}::${A++}` || t.uidEvent || A++
    }
/* === SECTION START: function L === */
...
/* === SECTION START: function z === */

    function z(t) {
        return "true" === t || "false" !== t && (t === Number(t).toString() ? Number(t) : "" === t || "null" === t ? null : t)
    }
/* === SECTION START: function q === */
...
/* === SECTION START: function dt === */

    function dt(t) {
        return t ? (t.nodeName || "").toLowerCase() : null
    }
/* === SECTION START: function ut === */
...
/* === SECTION START: function _t === */

    function _t(t) {
        return t.split("-")[0]
    }
/* === SECTION START: variable bt === */
    var bt = Math.round;
/* === SECTION START: function vt === */
...
/* === SECTION START: function Lt === */

    function Lt(t) {
        return ["top", "bottom"].indexOf(t) >= 0 ? "x" : "y"
    }
/* === SECTION START: variable xt === */
    var xt = Math.max,
        Dt = Math.min,
        St = Math.round;
/* === SECTION START: function Nt === */

    function Nt(t, e, i) {
        return xt(t, Dt(e, i))
    }
/* === SECTION START: function It === */
...
/* === SECTION START: variable ce === */
    var ce = {
        placement: "bottom",
        modifiers: [],
        strategy: "absolute"
    };
/* === SECTION START: function he === */
...
(function(e, t) {
    ...
    'use strict';
/* === SECTION START: function e === */

    function e(e) {
        return e && '[object Function]' === {}.toString.call(e)
    }
/* === SECTION START: function t === */
...
/* === SECTION START: function m === */

    function m(e, t, o, i) {
        return J(t['offset' + e], t['scroll' + e], o['client' + e], o['offset' + e], o['scroll' + e], ie() ? o['offset' + e] + i['margin' + ('Height' === e ? 'Top' : 'Left')] + i['margin' + ('Height' === e ? 'Bottom' : 'Right')] : 0)
    }
/* === SECTION START: function h === */
...
/* === SECTION START: variable r === */
        var r = {
            ...
            m = e.offsetHeight - d;
        if (l || m) {
/* === SECTION START: variable g === */
            var g = t(e);
            l -= f(g, 'x'), m -= f(g, 'y'), r.width -= l, r.height -= m
        }
        return c(r)
    }
/* === SECTION START: function u === */
...
! function(t, e) {
    ...
    "use strict";
/* === SECTION START: function _inheritsLoose === */

    function _inheritsLoose(t, e) {
        t.prototype = Object.create(e.prototype), (t.prototype.constructor = t).__proto__ = e
    }
/* === SECTION START: function _assertThisInitialized === */
...
/* === SECTION START: function fa === */

    function fa(t) {
        return t._gsap || ea(Ot(t))[0]._gsap
    }
/* === SECTION START: function ga === */

    function ga(t, e, r) {
        return (r = t[e]) && s(r) ? t[e]() : u(r) && t.getAttribute && t.getAttribute(e) || r
    }
/* === SECTION START: function ha === */

    function ha(t, e) {
        return (t = t.split(",")).forEach(e) || t
    }
/* === SECTION START: function ia === */

    function ia(t) {
        return Math.round(1e5 * t) / 1e5 || 0
    }
/* === SECTION START: function ja === */

    function ja(t) {
        return Math.round(1e7 * t) / 1e7 || 0
    }
/* === SECTION START: function ka === */
...
/* === SECTION START: function la === */

    function la(t, e) {
        for (var r = e.length, i = 0; t.indexOf(e[i]) < 0 && ++i < r;);
        return i < r
    }
/* === SECTION START: function ma === */
...
/* === SECTION START: function pa === */

    function pa(t) {
        return t
    }
/* === SECTION START: function qa === */

    function qa(t, e) {
        for (var r in e) r in t || (t[r] = e[r]);
        return t
    }
/* === SECTION START: function ta === */

    function ta(t, e) {
        for (var r in e) "__proto__" !== r && "constructor" !== r && "prototype" !== r && (t[r] = v(e[r]) ? ta(t[r] || (t[r] = {}), e[r]) : e[r]);
        return t
    }
/* === SECTION START: function ua === */
...
/* === SECTION START: function za === */

    function za(t, e) {
        !t.parent || e && !t.parent.autoRemoveChildren || t.parent.remove(t), t._act = 0
    }
/* === SECTION START: function Aa === */
...
/* === SECTION START: function _a === */

    function _a(t, e) {
        return t && v(t) && "length" in t && (!e && !t.length || t.length - 1 in t && v(t[0])) && !t.nodeType && t !== h
    }
/* === SECTION START: function cb === */
...
/* === SECTION START: function ob === */

    function ob(t) {
        for (var e, r, i, n, a = 0, s = ""; ~(e = t.indexOf("random(", a));) i = t.indexOf(")", e), n = "[" === t.charAt(e + 7), r = t.substr(e + 7, i - e - 7).match(n ? at : tt), s += t.substr(a, e - a) + hb(n ? r : +r[0], n ? 0 : +r[1], +r[2] || 1e-5), a = i + 1;
        return s + t.substr(a, t.length - a)
    }
/* === SECTION START: function rb === */
...
/* === SECTION START: function Ub === */

    function Ub(e, r) {
/* === SECTION START: function Pm === */
        function Pm(t) {
...
/* === SECTION START: function _recacheAncestors === */
...
/* === SECTION START: function Animation === */
...
/* === SECTION START: variable Ut === */
    var Ut = function(i) {
/* === SECTION START: function Timeline === */
...
/* === SECTION START: function _updatePropTweens === */
...
/* === SECTION START: function nc === */

    function nc(t, e, r) {
        return t.setAttribute(e, r)
    }
/* === SECTION START: function vc === */
...
/* === SECTION START: function PropTween === */
...
/* === SECTION START: function Context === */
...
/* === SECTION START: function MatchMedia === */

    function MatchMedia(t) {
        this.contexts = [], this.scope = t
    }
/* === SECTION START: variable Pe === */
    var Pe = {
...
/* === SECTION START: function Hc === */

    function Hc(t, e) {
        for (var r = t._pt; r && r.p !== e && r.op !== e && r.fp !== e;) r = r._next;
        return r
    }
/* === SECTION START: function Jc === */
...
/* === SECTION START: function td === */

    function td(t, e) {
        return e.set(e.t, e.p, Math.round(1e4 * (e.s + e.c * t)) / 1e4 + e.u, e)
    }
/* === SECTION START: function ud === */

    function ud(t, e) {
        return e.set(e.t, e.p, 1 === t ? e.e : Math.round(1e4 * (e.s + e.c * t)) / 1e4 + e.u, e)
    }
/* === SECTION START: function vd === */

    function vd(t, e) {
        return e.set(e.t, e.p, t ? Math.round(1e4 * (e.s + e.c * t)) / 1e4 + e.u : e.b, e)
    }
/* === SECTION START: function wd === */
...
/* === SECTION START: function xd === */

    function xd(t, e) {
        return e.set(e.t, e.p, t ? e.e : e.b, e)
    }
/* === SECTION START: function yd === */

    function yd(t, e) {
        return e.set(e.t, e.p, 1 !== t ? e.b : e.e, e)
    }
/* === SECTION START: function zd === */

    function zd(t, e, r) {
        return t.style[e] = r
    }
/* === SECTION START: function Ad === */

    function Ad(t, e, r) {
        return t.style.setProperty(e, r)
    }
/* === SECTION START: function Bd === */

    function Bd(t, e, r) {
        return t._gsap[e] = r
    }
/* === SECTION START: function Cd === */

    function Cd(t, e, r) {
        return t._gsap.scaleX = t._gsap.scaleY = r
    }
/* === SECTION START: function Dd === */
...
/* === SECTION START: function Id === */

    function Id(t) {
        t.translate && (t.removeProperty("translate"), t.removeProperty("scale"), t.removeProperty("rotate"))
    }
/* === SECTION START: function Jd === */
...
/* === SECTION START: function ue === */

    function ue(t, e) {
        for (var r in e) t[r] = e[r];
        return t
    }
/* === SECTION START: function ve === */
...
/* === SECTION START: variable a === */
            ...
            h(s, i), l(i)
        })) : s.parents(".cd-headline").hasClass("loading-bar") ? (s.parents(".cd-words-wrapper").removeClass("is-loading"), h(s, i), setTimeout((function() {
            d(i)
        }), t), setTimeout((function() {
            s.parents(".cd-words-wrapper").addClass("is-loading")
        }), 800)) : (h(s, i), setTimeout((function() {
            d(i)
        }), n))
    }
/* === SECTION START: function l === */
    ...
    function l(s, i) {
        s.parents(".cd-headline").hasClass("type") ? (o(s.find("i").eq(0), s, !1, i), s.addClass("is-visible").removeClass("is-hidden")) : s.parents(".cd-headline").hasClass("clip") && s.parents(".cd-words-wrapper").animate({
            width: s.width() + 10
        }, 600, (function() {
            setTimeout((function() {
                d(s)
