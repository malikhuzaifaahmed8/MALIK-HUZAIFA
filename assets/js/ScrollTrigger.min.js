/*
File: MALIK HUZAIFA/assets/js/ScrollTrigger.min.js
Type: JavaScript file
Root details: Contains functions and top-level variables. Detected function names: _defineProperties, r, z, A, B, C, F, G, Tc, J, K, L, pd, reset, getVelocity, M, N, O, _integrate, _bridge, P, _bridge, init, Qe, Re, Te, Ue, Ve, We, Ye, Ze, _e, af, bf, cf, df, ef, onStopFunc, _createClass, get, get, Observer, ya, za, Aa, Ba, Ca, Da, Ea, Fa, Ia, Ja, Ka, La, Ma, Na, Oa, Pa, eb, gb, ib, jb, lb, nb, ob, pb, qb, ub, vb, Ab, Bb, Cb, Db, Gb, Jb, Kb, Lb, Yb, _b, cc, ec, fc, Uj, _getBounds, _positionMarker, _dispatch, _refreshAll, _updateAll, _setState, init, _getSizeFunc, _getOffsetsFunc, onComplete, _getClosestLabel, _getLabelAtDirection, onInterrupt, onComplete, _makePositionable, _swapPinOut, _copyState, _queueRefreshAll, register, defaults, disable, enable, value, config, scrollerProxy, clearMatchMedia, isInViewport, positionInViewport, killAll, ScrollTrigger, Io, hc, ic, kc, lc, onEnable, onDisable, pc, Ep, Hp, Ip, Op, ignoreDrag, _captureInputs, ss, ref
...
! function(e, t) {
    ...
    "use strict";
/* === SECTION START: function _defineProperties === */
...
/* === SECTION START: variable o === */
        var o = e.tolerance,
            ...
            $ = e.lockAxis,
            Q = e.onLockAxis;
/* === SECTION START: function Qe === */

        function Qe() {
            return ye = Ne()
        }
/* === SECTION START: function Re === */
...
/* === SECTION START: function cf === */

        function cf(e) {
            se.event = e, D(se)
        }
/* === SECTION START: function df === */

        function df(e) {
            se.event = e, I(se)
        }
/* === SECTION START: function ef === */
...
/* === SECTION START: function Observer === */
...
/* === SECTION START: function ScrollTrigger === */
...
/* === SECTION START: function pc === */

    function pc(e) {
/* === SECTION START: function Ep === */
        function Ep() {
            return o = !1
        }
/* === SECTION START: function Hp === */

        function Hp() {
            i = Ia(p, Ke), S = tt(k ? 1 : 0, i), f && (T = tt(0, Ia(p, Xe))), l = Dt
        }
/* === SECTION START: function Ip === */
