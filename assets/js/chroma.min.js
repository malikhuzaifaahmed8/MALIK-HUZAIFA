/*
File: MALIK HUZAIFA/assets/js/chroma.min.js
Type: JavaScript file
Root details: Contains functions and top-level variables. Detected function names: Wn, Qn, ga
...
/* === SECTION START: variable Qt === */
    var Qt = Vt;
    Pt.hsl = function(r, e, n) {
        return Qt(r, e, n, "hsl")
    };
/* === SECTION START: variable ra === */
    var ra = Vt;
    Pt.hsv = function(r, e, n) {
        return ra(r, e, n, "hsv")
    };
/* === SECTION START: variable ea === */
    var ea = v;
...
/* === SECTION START: variable na === */
    var na = Vt;
    Pt.oklch = function(r, e, n) {
        return na(r, e, n, "oklch")
    };
/* === SECTION START: variable ta === */
    var ta = v,
        aa = l.clip_rgb,
        fa = Math.pow,
        oa = Math.sqrt,
...
/* === SECTION START: variable cf === */
        var cf = uf[ of ];
        ff[cf.toLowerCase()] = ff[cf]
    }
/* === SECTION START: variable lf === */
    var lf = ff,
        hf = y;
